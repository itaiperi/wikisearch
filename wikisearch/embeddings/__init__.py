...
from .fasttext_text_k_means import FastTextTextKMeans
...
from .word2vec_text_k_means import Word2VecTextKMeans
...
AVAILABLE_EMBEDDINGS = \
    [cls.__name__ for cls in [Doc2Vec,
                              ...
                              Word2VecTitle, Word2VecTextAverage, Word2VecTextKMeans, Word2VecTitleCategoriesMultiHot,
                              CategoriesMultiHot]]
...
EMBEDDINGS_MODULES = {
    ...
    Word2VecTextKMeans.__name__: 'word2vec_text_k_means',
